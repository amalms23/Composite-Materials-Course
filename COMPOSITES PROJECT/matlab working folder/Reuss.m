...
s_comp = Vf*s+Vm*s_matrix;

%
    Eff_E1 = 1.0/s_comp(1,1)
    Eff_E2 = 1.0/s_comp(2,2)
    Eff_E3 = 1.0/s_comp(3,3)
%
    Eff_G12 = 1.0/s_comp(4,4)
    Eff_G13 = 1.0/s_comp(5,5)
    HSS_G23 = 1.0/s_comp(6,6)
%
    Eff_NU12 = -s_comp(2,1) * Eff_E1
    Eff_NU21 = -s_comp(1,2) * Eff_E2
%
    Eff_NU31 = -s_comp(1,3) * Eff_E3
    Eff_NU13 = -s_comp(3,1) * Eff_E1
%
    Eff_NU23 = -s_comp(3,2) * Eff_E2
    Eff_NU32 = -s_comp(2,3) * Eff_E3
